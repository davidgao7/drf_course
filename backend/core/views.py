...
class ContactAPIView(views.APIView):
    ...
    def post(self, request):
        try:
            ...
            serializer = ContactSerializer(data=data)  # serialize it
            if serializer.is_valid(raise_exception=True):  # check the data
                serializer.save()  # save to database
                return Response(serializer.data)  # post to the frontend
            else:
